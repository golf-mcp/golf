...
class OAuthProxy(AuthProvider):
    ...
    def get_routes(self) -> List[Route]:
        ...
        routes = [
            ...
            Route("/.well-known/oauth-protected-resource", self._protected_resource_metadata, methods=["GET", "OPTIONS"]),
            Route("/.well-known/oauth-protected-resource/mcp", self._protected_resource_metadata, methods=["GET", "OPTIONS"]),
