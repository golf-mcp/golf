...
def build_project(
    ...
    from dotenv import load_dotenv
    from golf.auth import reset_auth_config
    from golf.auth.api_key import reset_api_key_config

    # Isolate this build from any process-global auth left by a previous project.
    reset_auth_config()
...
from golf.auth.api_key import ApiKeyMiddleware, configure_api_key, get_api_key_config
