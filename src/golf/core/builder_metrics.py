...
def generate_session_tracking() -> list[str]:
    ...
    return [
        ...
        "    pass",
        "",
        "# Background task to update uptime periodically",
        "async def _update_uptime_periodically():",
        ...
        "        except Exception:",
        "            # Don't let metrics collection break the server",
        "            pass",
        "",
        "# Start the uptime update task",
        "asyncio.create_task(_update_uptime_periodically())",
        "",
    ] 